      ...
      <div className="relative max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-5 h-full">
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 h-full transform transition-all duration-300 hover:scale-[1.02] flex flex-col">
              ...
              <div className="flex-grow mb-8">
                ...
                <p className="text-primary-400 text-base mt-3 font-medium italic">
          ...
          <div className="lg:col-span-7 h-full">
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 h-full transform transition-all duration-300 hover:scale-[1.02]">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="text-gray-300 text-sm">
                            <p>Behind Hero Showroom, Kanadia</p>
                        ...
                        <a href="mailto:info@floridpaints.com"
                          ...
                          <span className="text-sm">info@floridpaints.com</span>
                        </a>
                      </div>
                    </div>
                  </div>
