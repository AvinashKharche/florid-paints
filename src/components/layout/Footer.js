    ...
    <footer className="bg-gray-900">
      <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          {/* Brand Section */}
          <div>
            <h3 className="text-xl font-extrabold font-['Poppins'] text-white mb-6 pt-1">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white text-sm font-semibold tracking-wider uppercase mb-6 pt-1.5">
              Quick Links
            </h3>
